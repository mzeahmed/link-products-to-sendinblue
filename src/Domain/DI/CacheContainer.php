...
class CacheContainer extends Container
{
    ...
    {
        $container->services['LPTS\\Application\\Controllers\\Public\\Woocommerce\\SubscribeOnPaymentController'] = $instance = new \LPTS\Application\Controllers\Public\Woocommerce\SubscribeOnPaymentController(new \LPTS\Infrastructure\WordPress\Hook\Public\Woocommerce\SubscribeOnPaymentHook());
