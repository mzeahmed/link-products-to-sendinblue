...
class CacheContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = [
            ...
            'LPTS\\Application\\Controllers\\Admin\\Woocommerce\\ProductColumnController' => 'getCustomProductColumnControllerService',
            'LPTS\\Application\\Controllers\\Admin\\Woocommerce\\ProductPanelController' => 'getCustomProductPanelControllerService',
    ...
    {
        $container->services['LPTS\\Application\\Controllers\\Admin\\AdminEnqueueController'] = $instance = new \LPTS\Application\Controllers\Admin\AdminEnqueueController(
            new \LPTS\Infrastructure\WordPress\Hook\Admin\AdminEnqueueHook()
        );
    ...
    {
        $container->services['LPTS\\Application\\Controllers\\Admin\\SettingsController'] = $instance = new \LPTS\Application\Controllers\Admin\SettingsController(
            new \LPTS\Infrastructure\WordPress\Hook\Admin\SettingsHook(
                new \LPTS\Domain\Services\Admin\SettingsService(
                    ($container->privates['LPTS\\Infrastructure\\View\\Renderer'] ??= new \LPTS\Infrastructure\View\Renderer())
                )
            )
        );
     ...
     *
     * @return \LPTS\Application\Controllers\Admin\Woocommerce\ProductColumnController
     */
    protected static function getCustomProductColumnControllerService($container)
    {
        $container->services['LPTS\\Application\\Controllers\\Admin\\Woocommerce\\ProductColumnController'] = $instance = new \LPTS\Application\Controllers\Admin\Woocommerce\ProductColumnController(
            new \LPTS\Infrastructure\WordPress\Hook\Admin\Woocommerce\ProductColumnHook()
        );
     ...
     *
     * @return \LPTS\Application\Controllers\Admin\Woocommerce\ProductPanelController
     */
    protected static function getCustomProductPanelControllerService($container)
    {
        $container->services['LPTS\\Application\\Controllers\\Admin\\Woocommerce\\ProductPanelController'] = $instance = new \LPTS\Application\Controllers\Admin\Woocommerce\ProductPanelController(
            new \LPTS\Infrastructure\WordPress\Hook\Admin\Woocommerce\ProductPanelHook(
                ($container->privates['LPTS\\Infrastructure\\View\\Renderer'] ??= new \LPTS\Infrastructure\View\Renderer())
            )
        );
    ...
    {
        $container->services['LPTS\\Application\\Controllers\\Public\\Woocommerce\\SubscribeOnPaymentController'] = $instance = new \LPTS\Application\Controllers\Public\Woocommerce\SubscribeOnPaymentController(
            new \LPTS\Infrastructure\WordPress\Hook\Public\Woocommerce\SubscribeOnPaymentHook()
        );
    ...
    {
        if (
            !(isset($this->parameters[$name]) || isset($this->loadedDynamicParameters[$name]) || \array_key_exists(
                $name,
                $this->parameters
            ))
) {
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'app.admin_controller_ids' => [
                ...
                2 => 'LPTS\\Application\\Controllers\\Admin\\Woocommerce\\ProductColumnController',
                3 => 'LPTS\\Application\\Controllers\\Admin\\Woocommerce\\ProductPanelController',
            ],
        ];
    }
}
