...
class CacheContainer extends Container
{
    ...
    public function getRemovedIds(): array
    {
        return [
            ...
            'LPTS\\Domain\\Services\\Admin\\AdminEnqueueService' => true,
    ...
    {
        $container->services['LPTS\\Application\\Controllers\\Admin\\AdminEnqueueController'] = $instance = new \LPTS\Application\Controllers\Admin\AdminEnqueueController(new \LPTS\Infrastructure\WordPress\Hook\Admin\AdminEnqueueHook(new \LPTS\Domain\Services\Admin\AdminEnqueueService()));
    ...
    /**
     * Gets the public 'LPTS\Application\Controllers\Admin\Woocommerce\ProductColumnController' shared autowired service.
     *
     * @return \LPTS\Application\Controllers\Admin\Woocommerce\ProductColumnController
     */
    protected static function getProductColumnControllerService($container)
    {
        $container->services['LPTS\\Application\\Controllers\\Admin\\Woocommerce\\ProductColumnController'] = $instance = new \LPTS\Application\Controllers\Admin\Woocommerce\ProductColumnController(new \LPTS\Infrastructure\WordPress\Hook\Admin\Woocommerce\ProductColumnHook(new \LPTS\Domain\Services\Admin\Woocommerce\ProductColumnService()));
    ...
    /**
     * Gets the public 'LPTS\Application\Controllers\Admin\Woocommerce\ProductPanelController' shared autowired service.
     *
     * @return \LPTS\Application\Controllers\Admin\Woocommerce\ProductPanelController
     */
    protected static function getProductPanelControllerService($container)
    {
        $container->services['LPTS\\Application\\Controllers\\Admin\\Woocommerce\\ProductPanelController'] = $instance = new \LPTS\Application\Controllers\Admin\Woocommerce\ProductPanelController(new \LPTS\Infrastructure\WordPress\Hook\Admin\Woocommerce\ProductPanelHook(new \LPTS\Domain\Services\Admin\Woocommerce\ProductPanelService(($container->privates['LPTS\\Infrastructure\\View\\Renderer'] ??= new \LPTS\Infrastructure\View\Renderer()))));
